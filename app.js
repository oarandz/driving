...
async function reloadData(){if(state.demo)return;const [pupils,lessons,resources,links,videos,skills,activity,detailSkills,skillPins]=await Promise.all(['pupils','lessons','resources','lesson_resources','lesson_videos','pupil_skill_ratings','pupil_activity','pupil_detail_ratings','lesson_skill_pins'].map(allRows));Object.assign(state,{pupils,lessons,resources,links,videos,skills,activity,detailSkills,skillPins});}
...
function openLesson(id){
 ...
 showLessonResources(id);bindLessonResourceControls(id);showLessonSkills(id);
}
